class Shape {
  constructor() {
    (this.color = ""), (this.text = ""), (this.textColor = "");
  }
  setColor(color) {
    this.color = color;
  }
...
class Circle extends Shape {
  render() {
    return `<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="100" r="80" fill="${this.color}"/><text x="50%" y="50%" text-anchor="middle" stroke="${this.textColor}">${this.text}</text></svg>`;
  }
}
